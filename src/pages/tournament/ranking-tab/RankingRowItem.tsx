...
const RankingRowItem: React.FC<RankingRowItemProps> = (props) => {
    return (
        <IonRow className="row ion-justify-content-center ion-text-center">
            <IonCol className="ion-align-self-center" size="1" >{props.row.rank}</IonCol>
            ...
            <IonCol className="ion-align-self-center" size="2" >{props.row.w + '|' + props.row.d + '|' + props.row.l}</IonCol>
